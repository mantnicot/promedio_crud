...
type Estudiante struct {
	...
	CodigoMateria    int     `orm:"column(codigo_materia)"`
	Nota1            int     `orm:"column(nota_1)"`
	Nota2            int     `orm:"column(nota_2)"`
	Nota3            int     `orm:"column(nota_3)"`
	NotaDef          float32 `orm:"column(nota_def)"`
}
